...
public class AuthenticationRestControllerTest extends RestControllerTest {
	...
	public void signup_signedUpSuccessfully_shouldReturnToken() throws Exception {
		// given
		phone.put("number", 881111221).put("area_code", 81).put("country_code", "+55");

		user.put("firstName", "Renato").put("lastName", "Test").put("email", "renato@email.com").put("password", "123456")
	...
	public void signup_emailAlreadyExists_shouldReturnErrorMessage() throws Exception {
		...
		JSONObject otherUser = new JSONObject().put("firstName", "Renato").put("lastName", "Test")
				// same email as first user's
				.put("email", "renato@email.com").put("password", "123456").put("phones", new JSONArray().put(phone));
	...
	public void signup_invalidFields_shouldReturnErrorMessage() throws Exception {
		...
		user.put("firstName", "Renato").put("lastName", "Test")
				// an invalid email
	...
	public void signup_missingFields_shouldReturnErrorMessage() throws Exception {
		...
		user
				...
				.put("lastName", "Test").put("email", "renato@email.com").put("password", "123456")
				.put("phones", new JSONArray().put(phone));
	...
	public void signin_signedInSuccessfully_shouldReturnToken() throws Exception {
		// given
		phone.put("number", 881111221).put("area_code", 83).put("country_code", "+55");
		...
		credentials.put("email", "renato@email.com").put("password", "123456");
	...
	public void signin_nonexistentEmailOrWrongPassword_shouldReturnErrorMessage() throws Exception {
		...
		credentials
				// nonexistent email
				.put("email", "renato@email.com").put("password", "123456");
	...
	public void signin_missingFields_shouldReturnErrorMessage() throws Exception {
		// given
		credentials.put("email", "renato@email.com");
